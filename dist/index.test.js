...
describe('WebExtDevTools', () => {
    ...
    it('should evaluate expression in inspected window', async () => {
        ...
        chrome.devtools.inspectedWindow.eval.mockImplementation((expr, opts, cb) => cb(mockResult, null));
    ...
    it('should get HAR log', async () => {
        ...
        chrome.devtools.network.getHAR.mockImplementation((cb) => cb(mockHar));
    ...
    it('should create panel', async () => {
        ...
        chrome.devtools.panels.create.mockImplementation((t, i, p, cb) => cb(mockPanel));
    ...
    it('should create sidebar pane', async () => {
        ...
        chrome.devtools.panels.elements.createSidebarPane.mockImplementation((t, cb) => cb(mockPane));
    ...
    it('should handle evaluation exceptions', async () => {
        ...
        chrome.devtools.inspectedWindow.eval.mockImplementation((expr, opts, cb) => cb(null, mockException));
    ...
    it('should handle getHAR with empty result', async () => {
        chrome.devtools.network.getHAR.mockImplementation((cb) => cb({}));
        const result = await WebExtDevTools.network.getHAR();
